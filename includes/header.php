<header class="bg-light-blue">
    <nav class="navbar fixed-top navbar-expand-sm navbar-light bg-light-blue bg-gradient shadow">
        <div class="container">
            ...
            <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarID">
                <div class="navbar-nav">
                    <a class="nav-link active" aria-current="page" href="/">Home</a>
                    <a class="nav-link " href="/pages/service.php">Service</a>
...
<!-- <script src="assest/js/base.js"></script> -->